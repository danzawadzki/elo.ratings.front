...
const PlayerRight = ({playersList, teams, handleChange}) => (
    <div className="col-6 matchForm__player">
        ...
        <div className="row">
            <div className="col-3 p-1">
                ...
                <input type="number" className="form-control" id="awayGoals" onChange={handleChange} placeholder="0"/>
            </div>

            <div className="col-9 p-1">
                <small id="emailHelp" className="form-text text-muted">Player</small>
                <select id="awayPlayerId" className="form-control" onChange={handleChange}>
        ...
        <div className="row">
            <div className="col-6 p-1">
                ...
                <select id="awayTeamId" onChange={handleChange} className="form-control">
                    <option selected>Choose...</option>
